...
function Library:CreateWindow(WindowInfo)
    ...
    do
        ...
        Container = New("Frame", {
            ...
            Name = "Container",
            Position = UDim2.fromOffset(40, 49),
    ...
    function Window:AddTab(...)
        ...
        do
            ...
            -- Add active indicator (left border)
        ...
        function Tab:AddGroupbox(Info)
            ...
            do
                ...
                local CollapseIcon = Library:GetIcon("chevron-up")
                ...
                if CollapseIcon then
                    ...
                    CollapseArrow = New("ImageLabel", {
                        AnchorPoint = Vector2.new(0.5, 0.5),
                        Image = CollapseIcon.Url,
                        ImageColor3 = "FontColor",
                        ImageRectOffset = CollapseIcon.ImageRectOffset,
                        ImageRectSize = CollapseIcon.ImageRectSize,
                        ImageTransparency = 0.5,
                        Position = UDim2.fromScale(0.5, 0.5),
                        Size = UDim2.fromOffset(16, 16),
            ...
            if CollapseButton and CollapseArrow then
                local function ToggleCollapse()
                    print("Collapse button clicked for:", Info.Name)
                    ...
                    -- Rotate arrow
                    local RotationInfo = TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
                    ...
                    -- Update groupbox size immediately
                    Groupbox:Resize()
                end
                
                CollapseButton.MouseButton1Click:Connect(ToggleCollapse)
                print("Connected collapse button for:", Info.Name)
            end
