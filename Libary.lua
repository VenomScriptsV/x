...
local function FillInstance(Table: { [string]: any }, Instance: GuiObject)
    ...
    for k, v in pairs(Table) do
        ...
        elseif k ~= "Text" and (Library.Scheme[v] or typeof(v) == "function") then
            ...
            ThemeProperties[k] = v
            local resolvedValue = Library.Scheme[v] or v()
            if k:match("Color3") and typeof(resolvedValue) ~= "Color3" then
                resolvedValue = Color3.new(1, 1, 1) -- Safe fallback
            end
            Instance[k] = resolvedValue
            continue
        end
            ...
            if #Label.ColoredSegments == 0 then
                ...
                for i, segment in pairs(Label.ColoredSegments) do
                    ...
                    local SegmentLabel = New("TextLabel", {
                        ...
                        Text = segmentText,
                        TextColor3 = segment.color and Color3.fromHex(segment.color) or "FontColor",
                        TextSize = Data.Size,
                        TextXAlignment = Enum.TextXAlignment.Left,
                        Parent = LabelHolder,
                    })
