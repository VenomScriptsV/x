            ...
            if #Label.ColoredSegments == 0 then
                ...
                for i, segment in pairs(Label.ColoredSegments) do
                    ...
                    if segment.color then
                        segmentColor = Color3.fromHex(segment.color)
                    else
                        segmentColor = typeof(Library.Scheme.FontColor) == "Color3" and Library.Scheme.FontColor or Color3.new(1, 1, 1)
                    end
