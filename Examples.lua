local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/VenomScriptsV/x/refs/heads/main/Libary.lua"))()
local ThemeManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/VenomScriptsV/x/refs/heads/main/ThemeManager.lua"))()
local SaveManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/VenomScriptsV/x/refs/heads/main/SaveManager.lua"))()
...
local Window = Library:CreateWindow({
    Title = "AirFlow",
    Footer = "dsc.gg/airflowscript | Made By ZNX",
    Icon = 91464738152218,
    NotifySide = "Right",
...
local Tabs = {
	-- Creates a new tab titled Main with description
	Main = Window:AddTab("Main", "user",),
	Key = Window:AddKeyTab("Key System"),
	["UI Settings"] = Window:AddTab("UI Settings", "settings",),
}

local ColoredGroup = Tabs.Main:AddLeftGroupbox("Colored Text Examples", "palette")

-- Basic colored text
ColoredGroup:AddLabel({
    ColoredSegments = {
        {text = "Status: ", color = nil}, -- Default theme color
        {text = "Online", color = "00ff00"}, -- Green
        {text = " | Health: ", color = nil}, -- Default
        {text = "100%", color = "ff0000"}, -- Red
    }
})
...
ColoredGroup:AddLabel({
    ColoredSegments = {
        {text = "Player: ", color = "ffff00"}, -- Yellow
        {text = "ZNX", color = "00ffff"}, -- Cyan
        {text = " Level: ", color = nil}, -- Default
        {text = "999", color = "ff00ff"}, -- Magenta
    }
})
...
ColoredGroup:AddLabel({
    ColoredSegments = {
        {text = "R", color = "ff0000"}, {text = "a", color = "ff8000"}, {text = "i", color = "ffff00"},
        {text = "n", color = "80ff00"}, {text = "b", color = "00ff00"}, {text = "o", color = "00ff80"},
        {text = "w", color = "00ffff"}, {text = " T", color = "0080ff"}, {text = "e", color = "0000ff"},
        {text = "x", color = "8000ff"}, {text = "t", color = "ff00ff"},
    }
})

-- 3. COLLAPSIBLE SECTIONS (FIXED!)
local CollapsibleGroup = Tabs.Main:AddRightGroupbox("COLLAPSE TEST - CLICK →", "folder")

CollapsibleGroup:AddLabel("This section WILL collapse when you click the arrow button!")

CollapsibleGroup:AddToggle("TestToggle", {
    Text = "Test Feature",
    Default = false,
...
CollapsibleGroup:AddButton({
    Text = "Test Collapse Button",
    Func = function()
        Library:Notify("If you can click this, collapse is working!", 3)
    end,
})

-- Another collapse test
local CollapseTest2 = Tabs.Main:AddRightGroupbox("Second Collapse Test", "gear")

CollapseTest2:AddLabel("Another collapsible section!")
CollapseTest2:AddToggle("TestToggle2", {
